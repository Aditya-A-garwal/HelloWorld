...
TILE_NAMES = {
    ...
    # ores
    unobtaniumOre   : "block of unobtanium",
    diamondOre      : "block of diamond ore",
    platinumOre     : "block of platinum ore",
    goldOre         : "block of gold ore",
    ironOre         : "block of iron ore",
    copperOre       : "block of copper ore",
...
TILE_ATTR={
    ...
    hellstone:{ID:3,WEIGHT:99,FRICTION:0.4,LUMINOSITY:255,BREAKTIME:10,PLACEABLE:True,DAMAGE:10,HEALTH:100,INFLAMMABLE:0,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    unobtaniumOre:{ID:4,WEIGHT:85,FRICTION:0.7,LUMINOSITY:160,BREAKTIME:8,PLACEABLE:True,DAMAGE:10,HEALTH:90,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    diamondOre:{ID:5,WEIGHT:80,FRICTION:0.4,LUMINOSITY:175,BREAKTIME:7,PLACEABLE:True,DAMAGE:10,HEALTH:90,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    platinumOre:{ID:6,WEIGHT:75,FRICTION:0.4,LUMINOSITY:160,BREAKTIME:7,PLACEABLE:True,DAMAGE:10,HEALTH:80,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    goldOre:{ID:7,WEIGHT:70,FRICTION:0.4,LUMINOSITY:160,BREAKTIME:5,PLACEABLE:True,DAMAGE:10,HEALTH:70,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    ironOre:{ID:8,WEIGHT:65,FRICTION:0.4,LUMINOSITY:160,BREAKTIME:3,PLACEABLE:True,DAMAGE:10,HEALTH:70,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    ...
    copperOre:{ID:12,WEIGHT:65,FRICTION:0.4,LUMINOSITY:160,BREAKTIME:3,PLACEABLE:True,DAMAGE:10,HEALTH:60,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    ...
    coke:{ID:16,WEIGHT:40,FRICTION:0.4,LUMINOSITY:160,BREAKTIME:2,PLACEABLE:True,DAMAGE:10,HEALTH:50,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
    clay:{ID:17,WEIGHT:35,FRICTION:0.7,LUMINOSITY:0,BREAKTIME:2,PLACEABLE:True,DAMAGE:10,HEALTH:45,INFLAMMABLE:None,LIGHTPERMEABILITY:0,ILLUMINATION:0},
